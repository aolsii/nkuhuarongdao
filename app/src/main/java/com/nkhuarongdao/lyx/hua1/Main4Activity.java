...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        people[0] = (Button) findViewById(R.id.people21);
        people[1] = (Button) findViewById(R.id.people22);
        people[2] = (Button) findViewById(R.id.people23);
        people[3] = (Button) findViewById(R.id.people24);
        people[4] = (Button) findViewById(R.id.people25);
        people[5] = (Button) findViewById(R.id.people26);
        people[6] = (Button) findViewById(R.id.people27);
        people[7] = (Button) findViewById(R.id.people28);
        people[8] = (Button) findViewById(R.id.people29);
        people[9] = (Button) findViewById(R.id.people30);
        body = (FrameLayout)findViewById(R.id.HRD3);
        step = (TextView) findViewById(R.id.Text3);
        for (int i = 0; i < 10; i++)
    ...
    void init() {
        ...
        drawPeople(people[0],3,0);

        regular(people[1],1,1);
        drawPeople(people[1], 4, 0);

        regular(people[2], 1, 1);
        drawPeople(people[2], 3, 3);

        regular(people[3], 1, 1);
        drawPeople(people[3], 4, 3);

        regular(people[4], 1, 2);
        drawPeople(people[4], 0, 0);

        regular(people[5],1,2);
        drawPeople(people[5],0,3);

        regular(people[6],2,1);
        drawPeople(people[6],2,0);

        regular(people[7],2,1);
        drawPeople(people[7],2,2);

        regular(people[8],2,1);
        drawPeople(people[8],3,1);

        regular(people[9],2,2);
        drawPeople(people[9], 0, 1);
    }
}
