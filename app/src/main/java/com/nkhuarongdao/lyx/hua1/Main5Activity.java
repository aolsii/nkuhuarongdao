...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        people[0] = (Button) findViewById(R.id.people31);
        people[1] = (Button) findViewById(R.id.people32);
        people[2] = (Button) findViewById(R.id.people33);
        people[3] = (Button) findViewById(R.id.people34);
        people[4] = (Button) findViewById(R.id.people35);
        people[5] = (Button) findViewById(R.id.people36);
        people[6] = (Button) findViewById(R.id.people37);
        people[7] = (Button) findViewById(R.id.people38);
        people[8] = (Button) findViewById(R.id.people39);
        people[9] = (Button) findViewById(R.id.people40);
        body = (FrameLayout)findViewById(R.id.HRD4);
        step = (TextView) findViewById(R.id.Text4);
        for (int i = 0; i < 10; i++)
    ...
    void init() {
        ...
        drawPeople(people[2], 0, 3);

        regular(people[3], 1, 1);
        drawPeople(people[3], 1, 3);

        regular(people[4], 2, 1);
        drawPeople(people[4], 2, 0);

        regular(people[5],2,1);
        drawPeople(people[5],2,2);

        regular(people[6],2,1);
        drawPeople(people[6],3,0);

        regular(people[7],2,1);
        drawPeople(people[7],3,2);

        regular(people[8],2,1);
        drawPeople(people[8],4,1);
