...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        people[0] = (Button) findViewById(R.id.people1);
        people[1] = (Button) findViewById(R.id.people2);
        people[2] = (Button) findViewById(R.id.people3);
        people[3] = (Button) findViewById(R.id.people4);
        people[4] = (Button) findViewById(R.id.people5);
        people[5] = (Button) findViewById(R.id.people6);
        people[6] = (Button) findViewById(R.id.people7);
        people[7] = (Button) findViewById(R.id.people8);
        people[8] = (Button) findViewById(R.id.people9);
        people[9] = (Button) findViewById(R.id.people10);
        body = (FrameLayout)findViewById(R.id.HRD);
        step = (TextView) findViewById(R.id.Text1);
        for (int i = 0; i < 10; i++)
    ...
    void init() {
        ...
        drawPeople(people[0],4,0);
        regular(people[1],1,1);
        drawPeople(people[1], 3, 1);
        regular(people[2], 1, 1);
        drawPeople(people[2], 3, 2);
        ...
        regular(people[7],1,2);
        drawPeople(people[7],2,3);
        regular(people[8],2,1);
        drawPeople(people[8],2,1);
